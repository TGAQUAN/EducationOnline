    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="${pageContext.request.contextPath }/WEB-INF/pages/admin/adminLogin.jsp">管理员登录</a></li>
            </ul>
            <%
                if (name != null) {
            %>
...
<div class="container theme-showcase" role="main">
    ...
    <ol class="breadcrumb" style="margin-top: 100px">
        ...
        <li><a href="${pageContext.request.contextPath }/showDetail?id=<%=c.getId()%>" onsubmit=""><%=c.getName()%></a></li>
	...
	<div class="col-md-12 text-right">
		<yyf:page url="${pageContext.request.contextPath }/showStudent"></yyf:page>
		<%-- 分页标签 --%>
	</div>
