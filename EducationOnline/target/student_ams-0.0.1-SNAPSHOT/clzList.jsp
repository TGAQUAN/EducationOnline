...
<div class="container theme-showcase" role="main">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><a class="btn btn-primary" href="${pageContext.request.contextPath}/showDetail?id=<%=c.getId()%>">详情</a></td>
        </tr>
        <%
            }
        %>
...
<div class="col-md-12 text-right">
						<yyf:page url="${pageContext.request.contextPath }/showAllClasses"></yyf:page>
						<%-- 分页标签 --%>
					</div>
