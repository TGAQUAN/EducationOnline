...
<div class="container theme-showcase" role="main">
    ...
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><a class="btn btn-primary" href="${pageContext.request.contextPath}/showDetail?id=<%=c.getC_id()%>">详情</a>
                <a class="btn btn-danger" href="${pageContext.request.contextPath}/delCourse?id=<%=c.getC_id()%>">删除</a>
            </td>
        </tr>
        <%
            }
	...
	<div class="col-md-12 text-right">
		<yyf:page url="${pageContext.request.contextPath }/showMyClasses"></yyf:page>
		<%-- 分页标签 --%>
	</div>
